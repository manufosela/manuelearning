...
export class AdminSessionsList extends LitElement {
  ...
  static styles = css`
    ...
    .session-card { background: var(--color-bg-white, #fff); border-radius: 0.75rem; padding: 1.25rem; box-shadow: 0 1px 3px rgb(0 0 0 / 0.1); margin-bottom: 1rem; }
    .session-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; }
    .session-title { font-size: 1rem; font-weight: 700; color: var(--color-text-primary, #0f172a); }
    .session-meta { display: flex; flex-wrap: wrap; gap: 1rem; font-size: 0.813rem; color: var(--color-text-muted, #64748b); margin-bottom: 0.5rem; }
    ...
    .form-group input, .form-group select { width: 100%; padding: 0.5rem 0.75rem; border: 1px solid var(--color-border, #e2e8f0); border-radius: 0.375rem; font-size: 0.875rem; font-family: inherit; box-sizing: border-box; }
